...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="bg-primarySoft py-20 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">

        <div className="lg:col-span-5 flex justify-center relative">
          <div className="absolute inset-0 max-w-[400px] max-h-[400px] md:max-w-[450px] md:max-h-[450px] border-4 border-dashed border-accent/50 rounded-full animate-[spin_60s_linear_infinite] pointer-events-none" />
          <div className="absolute -top-4 -left-4 w-24 h-24 border-t-4 border-l-4 border-primary/30 rounded-tl-[40px] pointer-events-none" />
          <div className="absolute -bottom-4 -right-4 w-24 h-24 border-b-4 border-r-4 border-accent rounded-br-[40px] pointer-events-none" />
          ...
          <a
            ...
            className="absolute bottom-4 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-6 z-20 bg-white p-2 rounded-full shadow-lg flex items-center gap-3 cursor-pointer hover:scale-105 transition"
          >
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          {/* Heading */}
          <h2 className="text-4xl md:text-5xl font-extrabold text-primary leading-[1.15] mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-stretch">
            <div className={`md:col-span-8 p-6 rounded-2xl transition-all duration-300 shadow-sm ${tabContent[activeTab].bg}`}>
              <h3 className="text-xl font-bold mb-2 flex items-center gap-2">
                {activeTab === 'mission' ? '🎯' : '👁️‍🗨️'} {tabContent[activeTab].title}
              </h3>
            ...
            <div className="md:col-span-4 flex md:flex-col gap-3">
              <button
                onClick={() => setActiveTab('mission')}
                className={`flex-1 py-4 px-5 rounded-xl font-bold text-sm md:text-base transition-all duration-200 text-center md:text-left bg-accent text-white shadow-md ${activeTab === 'mission'
              ...
              <button
                ...
                className={`flex-1 py-4 px-5 rounded-xl font-bold text-sm md:text-base transition-all duration-200 text-center md:text-left ${activeTab === 'vision'
