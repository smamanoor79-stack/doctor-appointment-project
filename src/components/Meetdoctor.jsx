...
export default function MeetDoctor() {
  return (
    <section className="relative -mt-px bg-light pt-28 pb-20 px-6 md:px-16 overflow-hidden">
      ...
      <div aria-hidden="true" className="absolute top-10 left-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl z-0"></div>
      <div aria-hidden="true" className="absolute bottom-0 right-0 w-72 h-72 bg-accent/10 rounded-full blur-3xl z-0"></div>
      ...
      <span aria-hidden="true" className="hidden md:block absolute top-1/2 right-6 text-2xl opacity-10 select-none">✨</span>

      <div aria-hidden="true" className="hidden md:flex absolute top-24 right-[8%] w-16 h-16 lg:w-20 lg:h-20 bg-white rounded-2xl items-center justify-center shadow-lg text-3xl lg:text-4xl rotate-[8deg] z-10">
        🩺
      </div>
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="relative bg-white rounded-4xl shadow-[0_20px_50px_rgba(26,77,66,0.1)] border border-primarySoft px-6 md:px-12 py-10 flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-8 overflow-hidden">
          ...
          <div aria-hidden="true" className="absolute -top-10 -left-10 w-40 h-40 bg-accent/10 rounded-full blur-2xl"></div>

          {/* photo with ring accent */}
          <div className="relative shrink-0">
            <div aria-hidden="true" className="absolute -inset-2 rounded-full border-2 border-dashed border-accent/40"></div>
            <Image
              src="/banner-doctor.webp"
              alt="Portrait of Dr. Ahsan Malik, Consultant Dermatologist"
              width={144}
              height={144}
          ...
          <div className="relative text-center md:text-left flex-1">
            ...
            <p className="text-dark/60 text-sm flex items-center justify-center md:justify-start gap-1.5 mb-6">
              <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" className="w-4 h-4 shrink-0">
            ...
            <div className="flex justify-center md:justify-start">
              <a
                href="/book"
                className="inline-flex items-center gap-2 bg-light text-primary font-semibold px-6 py-3 rounded-full border-2 border-primary hover:bg-accent hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition hover:border-accent text-sm md:text-base"
              >
                Meet Your Doctor
                <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" className="w-4 h-4">
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-6 mb-12">
          <div className="relative overflow-hidden bg-linear-to-br from-primary to-primaryPale rounded-2xl py-6 px-4 text-center shadow-[0_10px_25px_rgba(26,77,66,0.25)] hover:-translate-y-1 transition-transform duration-300">
            <div aria-hidden="true" className="absolute -top-6 -right-6 w-20 h-20 bg-white/10 rounded-full blur-xl"></div>
          ...
          <div className="relative overflow-hidden bg-linear-to-br from-accent to-accentDark rounded-2xl py-6 px-4 text-center shadow-[0_10px_25px_rgba(232,146,124,0.3)] hover:-translate-y-1 transition-transform duration-300">
            <div aria-hidden="true" className="absolute -top-6 -right-6 w-20 h-20 bg-white/15 rounded-full blur-xl"></div>
