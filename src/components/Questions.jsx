      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="bg-white rounded-3xl p-8 text-center shadow-sm">
            ...
            <a
              href="/contact"
              className="inline-flex items-center gap-2 bg-accent text-white font-semibold px-6 py-3 rounded-full hover:bg-accentDark transition"
            >
              Contact Us
          ...
          <div className="bg-primary rounded-3xl p-8 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white font-bold text-lg">info@drahsanmalik.com</p>
            </div>
          </div>
        </div>
