...
export default function Newsletter() {
  ...
  const handleSubscribe = (e) => {
    e.preventDefault();
    setStatus(`Thanks! We've subscribed ${email} to our newsletter.`);
    setEmail("");
  };
  ...
  return (
    <section className="bg-light py-20 px-6 relative overflow-hidden">
      ...
      {/* Top Left Sparkle */}
      <div aria-hidden="true" className="absolute top-12 left-[8%] text-accent/20 animate-pulse hidden md:block">
      ...
      <div aria-hidden="true" className="absolute bottom-10 right-[6%] text-primary/15 hidden lg:block">
      ...
      <div aria-hidden="true" className="hidden md:flex absolute bottom-8 left-[6%] w-16 h-16 lg:w-20 lg:h-20 bg-white rounded-2xl items-center justify-center shadow-lg text-3xl lg:text-4xl rotate-[-8deg] z-20">
        🧴
      </div>
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-[2.5rem] p-8 md:p-14 lg:p-16 shadow-sm border border-primarySoft/30 flex flex-col lg:flex-row items-center justify-between gap-10 relative">
        ...
        <div aria-hidden="true" className="absolute right-6 top-6 text-accent/10 hidden sm:block">
        ...
        <div className="w-full max-w-md relative z-10">
          <form onSubmit={handleSubscribe}>
            ...
            <div className="relative flex items-center bg-primarySoft/30 p-2 rounded-full border border-primarySoft/50 focus-within:ring-2 focus-within:ring-accent/40 focus-within:bg-white transition-all duration-300 shadow-inner">
              <input
                id="newsletter-email"
                type="email"
                required
              ...
              <button
                ...
                className="absolute right-2 bg-accent text-white w-12 h-12 rounded-full flex items-center justify-center hover:bg-accentDark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition-all duration-300 shadow-md hover:shadow-lg group"
              >
                <svg 
                  aria-hidden="true"
                  focusable="false"
            ...
            <p role="status" aria-live="polite" className="text-primary text-sm mt-3 text-center lg:text-left">
              {status}
            </p>
          </form>
        </div>
